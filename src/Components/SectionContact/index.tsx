...
import { ContainerContact, ContainerEmailAndWhatsapp, ContentForm, ContentInfo, Iframe, TextArea } from "./styled"
    ...
    <ContainerContact>
     <ContentInfo>
        ...
        <ContainerEmailAndWhatsapp>
          <Envelope size={32} />
          <div>
            <TitleText size="s">Nosso Email</TitleText>
      ...
      <ContentForm>
        <TitleText>Envie sua mensagem</TitleText>
