    ...
    <ContainerAbout id="about">
      <ContentText data-aos="fade-right" data-aos-duration="1000">
        ...
        <TextRegular size="sm">
          ...
          personalizadas através da manipulação de medicamentos. Desenvolvemos
          fórmulas sob medida para atender às necessidades únicas de cada
          paciente, garantindo produtos de alta qualidade e eficácia.
        </TextRegular>

        <ContainerNumbersCompany>
          <DataCompanyOne>
            <TitleText color="blue-100">
              +{<CountUp end={1000} duration={3} decimal="4" />}
            </TitleText>
          ...
          <DataCompanyOne>
            <TitleText color="blue-100">
              +{<CountUp end={1500} duration={3} decimal="4" />}
            </TitleText>
