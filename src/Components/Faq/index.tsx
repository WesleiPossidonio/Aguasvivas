      ...
      <ContainerAcordion>
        <ContentAcordion>
          <Accordion>
            ...
            <AccordionDetails>
              <Typography>
                Uma farmácia de manipulação é um estabelecimento onde os
                medicamentos são preparados de forma personalizada, conforme
                prescrição médica, ajustados às necessidades individuais de cada
                paciente.
              </Typography>
            </AccordionDetails>
          </Accordion>
          ...
          <Accordion>
            ...
            >
              <Typography>
                Como faço para solicitar um medicamento manipulado?
              </Typography>
            </AccordionContent>
            <AccordionDetails>
              <Typography>
        ...
        <ContentAcordion>
          <Accordion>
            ...
            >
              <Typography>
                {' '}
                Os medicamentos manipulados têm validade?
              </Typography>
            </AccordionContent>
            <AccordionDetails>
              <Typography>
          ...
          <Accordion>
            ...
            >
              <Typography>
                Como posso pagar pelos medicamentos manipulados?
              </Typography>
            </AccordionContent>
            <AccordionDetails>
              <Typography>
                Você pode pagar pelos medicamentos manipulados de diversas
                formas, incluindo dinheiro, cartões de crédito e débito, e
                algumas farmácias de manipulação também aceitam planos de saúde.
              </Typography>
            </AccordionDetails>
          </Accordion>
          ...
          <Accordion>
            ...
            <AccordionDetails>
              <Typography>
                Sim, muitas farmácias de manipulação oferecem o serviço de
                encomenda de medicamentos via internet. Você pode enviar sua
                receita por e-mail ou através de formulários específicos
          ...
          <Accordion>
            ...
            <AccordionDetails>
              <Typography>
                ...
                ser mais caros que os industrializados devido à sua
                personalização e preparo individualizado.
              </Typography>
            </AccordionDetails>
          </Accordion>
